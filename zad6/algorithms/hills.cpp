...
void det_hill_solution(solved_Puzzle_t &test, int iters, bool c_t, bool c_c, bool a, bool q, bool c_i) {
    int n = 0;
    clock_t start;
    double duration;
    start = clock();
...
void rand_hill_solution(solved_Puzzle_t &test, int iters, bool c_t, bool c_c, bool a, bool q, bool c_i) {
    int n = 0;
    clock_t start;
    double duration;
    start = clock();
