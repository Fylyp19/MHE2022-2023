...
void func(string name, int iters ,int tabu, solved_Puzzle_t &puzzle, bool c_t, bool c_c,
    ...
    if(name == "brute"){
        brute_force(puzzle, c_t, c_c, a, q, c_i);
    } else if (name == "random"){
        random_solution(puzzle, iters, c_t, c_c, a, q, c_i);
    } else if (name == "hill1"){
        det_hill_solution(puzzle, iters, c_t, c_c, a, q, c_i);
    } else if (name == "hill2"){
        rand_hill_solution(puzzle, iters, c_t, c_c, a, q, c_i);
    } else if (name == "tabu"){
...
int main(int argc, char **argv){
    ...
    func(func_name, iterations, tabu, test, count_time, count_iterations,
